...
function makeBubble() {
  ...
  for (i = 1; i <= 200; i++) {
    ...
    clutter += "<div class=\"bg-green-500 h-10 w-10 rounded-full mt-2 ml-3 text-center pt-1 hover:bg-green-700 cursor-pointer\">".concat(a, "</div>");
  }
...
function Timer() {
  ...
  var runtime = setInterval(function () {
    if (timer >= 1) {
      ...
      document.querySelector("#btm").innerHTML = "<h1>Your score is:</h1>".concat(score);
    }
  }, 1000);
}
